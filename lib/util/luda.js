...
/**
 * Represents the standardized numerical size names provided by Luda classes and utilities
 */
export const NUMERICAL_SIZE_NAMES = {
    one: "1",
    two: "2",
    three: "3",
    four: "4",
...
/**
 * Represents the standardized textual size names provided by Luda classes and utilities
 */
export const TEXTUAL_SIZE_NAMES = {
    auto: "auto",
    fluid: "fluid",
    large: "large",
    medium: "medium",
